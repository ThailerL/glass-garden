	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					'border-border bg-background hover:bg-muted hover:text-foreground active:bg-accent dark:bg-input/30 dark:border-input dark:hover:bg-input/50 dark:active:bg-input/70 aria-expanded:bg-muted aria-expanded:text-foreground shadow-xs',
				secondary:
